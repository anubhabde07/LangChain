...
# Print all available docstore IDs
# print("Available docstore IDs:", vector_store.index_to_docstore_id)
...
query = "How does NVIDIA make big bets on specific chips (transformers)?"
received_docs = retriever.invoke(query)

content_text = '\n\n'.join(doc.page_content for doc in received_docs)

final_prompt = prompt.invoke({'context': content_text, 'question': query})
